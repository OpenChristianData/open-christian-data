...
**Coding defaults:** All scripts follow the project conventions in `.claude/rules/` (absolute paths, logging, summaries, quality stats, utf-8 encoding, ASCII-only print output).
