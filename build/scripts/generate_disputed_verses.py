...
def compute_disputed(bsb_index: dict, kjv_index: dict,
                     versification_offsets: set) -> dict:
...
def main() -> None:
    ...
    # Import versification offsets (moved here from module level for PY-06 compliance)
    ...
    # Compute diff
    disputed = compute_disputed(bsb_index, kjv_index, VERSIFICATION_OFFSETS)
