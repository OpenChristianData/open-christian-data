...
from build.lib._generated_enums import (
    TOPICAL_REFERENCE__META__COMPLETENESS,
    TOPICAL_REFERENCE__META__PROVENANCE__PROCESSING_METHOD,
...
for _t in ["evangelical", "non-denominational"]:
    assert _t in TOPICAL_REFERENCE__META__TRADITION, f"invalid tradition {_t!r}"
assert "full" in TOPICAL_REFERENCE__META__COMPLETENESS, "invalid completeness 'full'"
assert "automated" in TOPICAL_REFERENCE__META__PROVENANCE__PROCESSING_METHOD, "invalid processing_method 'automated'"
