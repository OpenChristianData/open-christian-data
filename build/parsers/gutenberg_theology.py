...
from build.lib._generated_enums import STRUCTURED_TEXT__DEFS__SECTION__SECTION_TYPE  # noqa: E402
...
_invalid = [v for v in SECTION_TYPE_MAP.values() if v not in STRUCTURED_TEXT__DEFS__SECTION__SECTION_TYPE]
assert not _invalid, f"SECTION_TYPE_MAP has invalid section_type values: {_invalid}"
...
def build_meta_envelope(
    ...
    return {
        ...
        "provenance": {
            ...
            "notes": append_pg_inline_markup_note(notes),
        },
    }
...
def run_calvin(dry_run: bool, log_lines: list) -> bool:
    ...
    hash_v1 = compute_source_hash(path_v1)
    hash_v2 = compute_source_hash(path_v2)
