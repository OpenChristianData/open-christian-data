...
| build/parsers/creeds_json_catechism.py | 2026-03-28 | Opus review: H1 author can be null but schema required string -- fixed in schema. M2 _parse_sort_key returns 0 on failure (schema min=1) -- low risk, flagged. M3 --all log loss on crash -- flagged. L1-L3 duplication noted. |
